...
const ChangePassword = ({ onChangePassword }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (newPassword !== confirmPassword) {
      toast.error(
        "New password and Confirm password must be same! / नवीन पासवर्ड आणि पुष्टी पासवर्ड सारखे असणे आवश्यक आहे!"
      );
      return;
    }
    mutate({
      ...
      <div className="min-h-40 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-sm text-gray-500 text-center mb-6">
            Update your password securely / आपला पासवर्ड सुरक्षितपणे अद्यतनित करा
          </p>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Current password / सध्याचा पासवर्ड"
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="New password / नवीन पासवर्ड"
              value={newPassword}
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Confirm new password / नवीन पासवर्ड पुन्हा लिहा"
